...
class AdvancedAppearanceSettingTab extends PluginSettingTab {
  ...
  display(): void {
    ...
    donateText.appendText(
      'If you enjoy Advanced Appearance, consider supporting its development using the links below:',
    );
...
<path fill="#FDE6E1" d="M142.12,42H7.88C3.53,42,0,38.47,0,34.12V7.88C0,3.53,3.53,0,7.88,0h134.25c4.35,0,7.88,3.53,7.88,7.88v26.25     C150,38.47,146.47,42,142.12,42z"/>
<path fill="#F1593F" d="M10.5,10.94h3.69v20.12H10.5V10.94z"/>
<path fill="#F6907F" d="m23.96 10.94c-4.17 0-7.56 3.39-7.56 7.55s3.39 7.53 7.56 7.53c4.16 0 7.54-3.38 7.54-7.53 0-4.16-3.38-7.55-7.54-7.55z"/>
<path fill="#161719" d="m44.89 14.96h4.9c2.59 0 4.27 1.96 4.27 4.23s-1.67 4.23-4.27 4.23h-2.19v3.25h-2.71v-11.71zm6.44 4.24c0-1.09-0.74-2.03-1.87-2.03h-1.86v4.05h1.86c1.14 0 1.87-0.94 1.87-2.02z"/>
<path fill="#161719" d="m64.44 26.68-0.45-1.42h-4.17l-0.45 1.42h-2.9l4.18-11.72h2.49l4.23 11.72h-2.93zm-2.53-8.37-1.44 4.82h2.85l-1.41-4.82z"/>
<path fill="#161719" d="M71.94,17.3h-2.64v-2.34h8.02v2.34h-2.66v9.37h-2.71V17.3z"/>
<path fill="#161719" d="m81.53 14.96h4.92c2.59 0 4.27 1.96 4.27 4.23 0 1.64-0.87 3.1-2.33 3.78l2.34 3.7h-3.15l-2.08-3.25h-1.27v3.25h-2.71v-11.71zm6.44 4.24c0-1.09-0.74-2.03-1.87-2.03h-1.86v4.05h1.86c1.13 0 1.87-0.94 1.87-2.02z"/>
<path fill="#161719" d="M98.03,17.14v2.66h4.44v2.13h-4.44v2.58h4.44v2.18h-7.15V14.96h7.15v2.18H98.03z"/>
<path fill="#161719" d="m106.87 20.82c0-3.21 2.31-6.16 6.21-6.16 3.88 0 6.19 2.95 6.19 6.16s-2.31 6.16-6.19 6.16c-3.9 0-6.21-2.95-6.21-6.16zm9.64 0c0-1.92-1.31-3.72-3.43-3.72-2.14 0-3.43 1.79-3.43 3.72s1.29 3.72 3.43 3.72c2.12-0.01 3.43-1.8 3.43-3.72z"/>
<path fill="#161719" d="m130.83 22.59v-7.63h2.69v11.72h-2.83l-4.22-7.53v7.53h-2.71v-11.72h2.83l4.24 7.63z"/>
</svg>`;
